...
func CertProvisionerForService(service types.NamespacedName, opts Options) CertificateProvisioner {
	...
	certName := util.ObjectNameForBaseAndSuffix(service.Name, "cert")
